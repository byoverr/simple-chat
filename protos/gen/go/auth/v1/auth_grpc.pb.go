...
const (
	AuthService_Register_FullMethodName = "/chat.v1.AuthService/Register"
	AuthService_Login_FullMethodName    = "/chat.v1.AuthService/Login"
	AuthService_Refresh_FullMethodName  = "/chat.v1.AuthService/Refresh"
	AuthService_Logout_FullMethodName   = "/chat.v1.AuthService/Logout"
	AuthService_WhoAmI_FullMethodName   = "/chat.v1.AuthService/WhoAmI"
)
...
type AuthServiceClient interface {
	...
	Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*AuthPair, error)
...
func (c *authServiceClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*AuthPair, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthPair)
...
type AuthServiceServer interface {
	...
	Login(context.Context, *LoginRequest) (*AuthPair, error)
...
func (UnimplementedAuthServiceServer) Login(context.Context, *LoginRequest) (*AuthPair, error) {
